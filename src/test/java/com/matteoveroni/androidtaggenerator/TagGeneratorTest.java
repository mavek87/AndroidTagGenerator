...
public class TagGeneratorTest {
     ...
     * Aaaaaa = 6 Bbbb = 4 Ccccc = 5 Dddddd = 6 Eeeeee = 6
     */
    @Test
    ...
    /**
     * AaaaaaaaaaaBbbbCcccccccDdddddEeeeee = 35 letters (12 letter longer than
     * max) Aaaaaa = 11 Bbbb = 4 Ccccc = 8 Dddddd = 6 Eeeeee = 6
     */
    @Test
    ...
    /**
     * AAaaaaBbbbCcCCcccDdddddEEEeee = 29 letters (6 letter longer than max) A =
     * 1 Aaaaa = 5 -1 = 4 Aaaa Bbbb = 4 Cc = 2 C = 1 Cccc = 4 -1 = 3 Ccc Dddddd
     * = 6 -3 = 3 Ddd E = 1 E = 1 Eeee = 4 -1 = 3 Eee
     */
    @Test
    ...
    /**
     * AAaaaaBbbbCcCcCcccDdddddEEEeee = 31 letters (8 letter longer than max) A
     * = 1 Aaaaa = 5 -1 = 4 Aaaa Bbbb = 4 -1 = 3 Bbb Cc = 2 Cc = 2 Cccc = 4 -1 =
     * 3 Ccc Ddddddd = 7 -4 = 3 Ddd E = 1 E = 1 Eeee = 4 -1 = 3 Eee
     */
    @Test
    ...
    /**
     * aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa = 60 letters
     * (17 letter longer than max)
     */
    @Test
